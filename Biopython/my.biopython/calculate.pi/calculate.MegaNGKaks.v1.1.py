...
'''
        FILE: calculate.MegaNGKaks.v1.1.py
       USAGE: $ python calculate.MegaNGKaks.v1.1.py -h
...
ORGANIZATION: Nanjing University, China
 ...
 CHANGE LOGS:
     ...
     Version 1.1 2016/5/25 18:04:48    精简代码
'''
...
def get_pn_ps(seq1, seq2):
    ...
    for i in range(0, align_len_seq1, 3):
        codon1 = ''.join(base1[i:i+3])
        codon2 = ''.join(base2[i:i+3])
        #print(codon1, '-', codon2)
...
for fasfile in(args.fasta_in,):
    ...
    for i in range(len(locus_list)):
        ...
        for j in range(i+1, len(locus_list)):
            ...
            (seq1,seq2)=OverLapCodon(first,second)
            if seq1 == '':
                dNdS = '-/-'
                dN = '-'
                dS = '-'
